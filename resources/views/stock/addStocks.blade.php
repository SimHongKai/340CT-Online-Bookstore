...
<body>
    ...
    <script src="{{ URL::asset('/js/addStock.js') }}"></script>
            ...
            if (str.length == 0) {
                ...
                xmlhttp.onreadystatechange = function () {
                    ...
                    if (this.readyState == 4 && this.status == 200) {
                        document.getElementById("bookTitle").removeAttribute('readonly');
                        document.getElementById("bookDesc").removeAttribute('readonly');
                        document.getElementById("bookAuthor").removeAttribute('readonly');
                        document.getElementById("publicationDate").removeAttribute('readonly');
                        document.getElementById("tradePrice").removeAttribute('readonly');
                        document.getElementById("retailPrice").removeAttribute('readonly');
                        document.getElementById("tradePriceSlider").removeAttribute('readonly');
                        document.getElementById("retailPriceSlider").removeAttribute('readonly');
                        // parse the returned JSON
                        if (this.responseText == null){
                            return;
                        }else{
                            var stock = JSON.parse(this.responseText);
                            document.getElementById("bookTitle").setAttribute('readonly', true);
                            document.getElementById("bookDesc").setAttribute('readonly', true);
                            document.getElementById("bookAuthor").setAttribute('readonly', true);
                            document.getElementById("publicationDate").setAttribute('readonly', true);
                            document.getElementById("tradePrice").setAttribute('readonly', true);
                            document.getElementById("retailPrice").setAttribute('readonly', true);
                            document.getElementById("tradePriceSlider").setAttribute('readonly', true);
                            document.getElementById("retailPriceSlider").setAttribute('readonly', true);
                        }
                        //fill in form data
